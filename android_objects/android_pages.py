...
from android_objects.android_page_locators import AndroidPageLocators
...
class AndroidAppPage(BasePage):
    """Android app page action methods"""
    ...
    def navigate_app_links_verify_text_displayed_in_modal(self):
        AndroidPageLocators.app_link(self).click()
        AndroidPageLocators.alert_dialog_link(self).click()
        AndroidPageLocators.cancel_dialog_with_message_link(self).click()
        modal_text = AndroidPageLocators.get_text_from_modal(self)
        return modal_text
